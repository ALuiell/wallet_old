...
class Category(Wallet):
    ...
    def categories_one(self):
        ...
        def menu_cat1():
            ...
            self.menu_universal(menu_cat1, 5, functional)
    ...
    def categories_two(self):
        ...
        def menu_cat2():
            ...
            self.menu_universal(menu_cat2, 6, functional)
    ...
    def categories_three(self):
        ...
        def menu_cat3():
            ...
            self.menu_universal(menu_cat3, 6, functional)
    ...
    def categories_four(self):
        ...
        def menu_cat4():
            ...
            self.menu_universal(menu_cat4, 3, functional)
